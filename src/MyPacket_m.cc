...
void MyPacket::copy(const MyPacket& other)
{
    ...
    this->xSend = other.xSend;
    this->ySend = other.ySend;
...
void MyPacket::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->xSend);
    doParsimPacking(b,this->ySend);
...
void MyPacket::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->xSend);
    doParsimUnpacking(b,this->ySend);
    doParsimUnpacking(b,this->msgNum);
    doParsimUnpacking(b,this->time);
}

int MyPacket::getSourceId() const
{
    return this->sourceId;
}

void MyPacket::setSourceId(int sourceId)
{
    handleChange();
    this->sourceId = sourceId;
}

double MyPacket::getPeriod() const
{
    return this->period;
}

void MyPacket::setPeriod(double period)
{
    handleChange();
    this->period = period;
}

omnetpp::simtime_t MyPacket::getSendTime() const
{
    return this->sendTime;
}

void MyPacket::setSendTime(omnetpp::simtime_t sendTime)
{
    handleChange();
    this->sendTime = sendTime;
}

double MyPacket::getXSend() const
{
    return this->xSend;
}

void MyPacket::setXSend(double xSend)
{
    handleChange();
    this->xSend = xSend;
}

double MyPacket::getYSend() const
{
    return this->ySend;
}

void MyPacket::setYSend(double ySend)
{
    handleChange();
    this->ySend = ySend;
}

int MyPacket::getMsgNum() const
{
    return this->msgNum;
}

void MyPacket::setMsgNum(int msgNum)
{
    handleChange();
    this->msgNum = msgNum;
}

omnetpp::simtime_t MyPacket::getTime() const
{
    return this->time;
}

void MyPacket::setTime(omnetpp::simtime_t time)
{
    handleChange();
    this->time = time;
}
...
MyPacketDescriptor::MyPacketDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::MyPacket)), "inet::FieldsChunk")
{
...
unsigned int MyPacketDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        0,    // FIELD_sendTime
        FD_ISEDITABLE,    // FIELD_xSend
        FD_ISEDITABLE,    // FIELD_ySend
...
int MyPacketDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0] == 'x' && strcmp(fieldName, "xSend") == 0) return base+3;
    if (fieldName[0] == 'y' && strcmp(fieldName, "ySend") == 0) return base+4;
    if (fieldName[0] == 'm' && strcmp(fieldName, "msgNum") == 0) return base+5;
...
std::string MyPacketDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_xSend: return double2string(pp->getXSend());
        case FIELD_ySend: return double2string(pp->getYSend());
        case FIELD_msgNum: return long2string(pp->getMsgNum());
...
bool MyPacketDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_period: pp->setPeriod(string2double(value)); return true;
        case FIELD_xSend: pp->setXSend(string2double(value)); return true;
        case FIELD_ySend: pp->setYSend(string2double(value)); return true;
        case FIELD_msgNum: pp->setMsgNum(string2long(value)); return true;
